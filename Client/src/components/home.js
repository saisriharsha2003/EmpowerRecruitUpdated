                ...
                <section id="hero_ui_07">
                    <div id="inj1t" className="container-fluid">
                        <div id="igxt4" className="row align-items-center">
                            <div id="ideen" className="col-xl-7 col-lg-7 hero_7_content col-md-7">
                            ...
                            <div id="iv3t9" className="col-xl-5 col-lg-5 hero_07_right_image text-right col-md-5">
                                <img src="https://drapcode-upload.s3.amazonaws.com/i76esavp98z1o1e56x7n387u0z91/eff4a076-4d4e-41df-a19c-03ab21b80b64.jpeg" alt="" id="io01p" className="img-fluid" />
                            </div>
                        </div>
                    </div>
                </section>
            ...
            <section data-js="drapcode-sections" id="ipj6f" className="dc-sections">
                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div id="i9a1s" className="col-12 col-sm-12 col-xl-4 col-lg-4 col-md-6">
            ...
            <section data-js="drapcode-sections" id="iirxi" className="dc-sections">
                <div className="container">
                    <div id="ixftz" className="row">
                        <div id="imqoh" className="col-12 col-sm-12 col-md-12 col-lg-11 col-xl-11">
                            <section data-js="drapcode-sections" id="issjf" className="dc-sections">
                                <div className="container">
                                    <div id="i8vt2" className="row border-radius p-5">
                                        ...
                                        <div id="imf0h" className="col-12 col-sm-12 col-md-6 col-lg-9 col-xl-9">
                    ...
                    <div className="row">
                        <div id="ifnrw1" className="col-12 col-sm-12 col-md-12 col-lg-11 col-xl-11">
                            <section data-js="drapcode-sections" id="iijhx5" className="dc-sections">
                                <div className="container"><div id="idryj7" className="row border-radius p-5">
            ...
            <footer id="footer">
                    ...
                    <div id="i5q44h" className="container">
                        <div className="row">
                            <div id="i18wpk" className="col-lg-3 col-md-6 footer-contact">
                                <h2 id='iiiyuw'>Talent Trail</h2>
                                <p id="ih0p74" className="font-italic fs-08">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam</p>
                            </div>
                ...
                <div className="container footer-bottom clearfix">
                    <div className="copyright">
                        © Copyright
                        <strong><span>Example Software</span></strong>. All Rights Reserved
                    </div>
                </div>
            </footer>
